...
export default function Bedroombanner({}) {
  ...
  const topBottomBanner = async () => {
    try {
      const response = await Api.get(
        `${Endpoints.getBanners}?page=home&pageReference=top-bottom`,
        {
          headers: {},
        }
      );
  ...
  return (
    <div>
      ...
      >
        <img
          src={`${Api.defaults.baseURL}${topBottom}`}
