...
interface EditAddAddressFormPropsValues {
  name: string;
  phone: string;
  landline: string;
  addressLine1: string;
...
export interface EditAddAddressFormProps {
  editAddressData: any;
  open: any;
  setOpen: any;
  editAddressId: any;
...
const EditAddAddressForm: React.FC<EditAddAddressFormProps> = ({
  editAddressData,
  open,
  setOpen,
  editAddressId,
  ...
  const formik = useFormik<EditAddAddressFormPropsValues>({
    initialValues: {
      name: editAddressData?.name,
      phone: editAddressData?.phoneNumber,
      landline: editAddressData?.landlineNumber,
      ...
      defaultAddress: editAddressData?.defaultAddress,
    },
    onSubmit: (values) => {
      ...
      letsEditShippingAddress(values, locationDetails, editAddressId);
    },
  });
        ...
        <div className="bg-white p-4 w-full max-w-4xl">
            ...
            <div className="w-full h-full">
              <div style={{ marginBottom: "16px", marginTop: 10 }}>
                ...
                <input
                  ...
                  name="name"
                  type="text"
                  placeholder={editAddressData?.name}
            ...
            >
              <div style={{ flex: "0 0 48%" }}>
                ...
                <input
                  ...
                  name="phone"
                  type="text"
                  placeholder={editAddressData?.phoneNumber}
                  onChange={formik.handleChange}
              ...
              <div style={{ flex: "0 0 48%" }}>
                ...
                <input
                  ...
                  name="landline"
                  type="text"
                  placeholder={editAddressData?.landlineNumber}
                  onChange={formik.handleChange}
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <input
              ...
              name="addressLine1"
              type="text"
              placeholder={editAddressData?.address1}
              onChange={formik.handleChange}
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <input
              ...
              name="addressLine2"
              type="text"
              placeholder={editAddressData?.address2}
              onChange={formik.handleChange}
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <input
              ...
              name="zipCode"
              type="text"
              placeholder={editAddressData?.zipCode}
              onChange={formik.handleChange}
