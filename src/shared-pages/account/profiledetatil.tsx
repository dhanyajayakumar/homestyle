...
export default function Profiledetatil({}) {
        ...
        <div className="flex flex-1 min-w-[320px] gap-5 xl:flex-row lg:flex-col flex-col mb-4 !border-gray-200 dark:border-gray-700 ">
          ...
          <div>
            ...
            >
              {/* <!-- dsahboard --> */}
              <li
                className={`bg-[#FEF1DE] duration-150 hover:bg-[#ffd89e] ${
                  activeTab === "dashboard" ? "bg-[#ffd89e]" : ""
                }`}
                role="presentation"
              >
                <button
                  className="flex w-full items-center py-2 px-3 gap-3 font-normal !text-black !hover:text-black"
                  id="dashboard-tab"
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M0,481c0-78.67,0-157.33,0-236,.16-.29.39-.56.48-.87,6.45-21.64,18.76-30.88,41.23-30.88,50.99,0,101.98-.03,152.97.01,24.27.02,39.99,15.79,40.05,40.09.05,19.83.01,39.66.01,59.49,0,53.16,0,106.31,0,159.47,0,16.27-6.77,28.59-21.49,36.02-3.22,1.62-6.83,2.47-10.26,3.68H32c-11.8-2.81-21.57-8.56-27.4-19.6-1.9-3.61-3.09-7.59-4.6-11.4Z"
                      // style="fill: #603813; stroke-width: 0px;"
                    />
                    <path
                      d="M203,0c6.21,3.02,13.07,5.17,18.49,9.25,9.33,7.02,13.2,17.36,13.23,28.94.09,31.49.23,62.98-.04,94.47-.19,21.95-16.05,37.91-38,38.01-52.82.24-105.63.18-158.45.02-18.8-.06-32.66-11.3-37.31-29.39-.2-.79-.6-1.53-.91-2.3,0-36,0-72,0-108,.61-1.68,1.27-3.35,1.83-5.04C5.23,15.81,11.67,8.3,21.36,3.74c3.11-1.46,6.42-2.51,9.64-3.74,57.33,0,114.67,0,172,0Z"
                      // style="fill: #603813; stroke-width: 0px;"
                    />
                    <path
              ...
              {/* <!-- my profile --> */}
              <li
                className={cn(`bg-[#FEF1DE] duration-150 hover:bg-[#ffd89e] `, {
                  "bg-[#ffd89e]": activeTab === "profile",
                })}
                role="presentation"
              >
                <button
              ...
              <li className="bg-[#FEF1DE] duration-150 hover:bg-[#ffd89e]">
                <button
                  className="flex w-full gap-3 items-center py-2 px-3 font-normal !text-black !hover:text-black"
                  id="contacts-tab"
